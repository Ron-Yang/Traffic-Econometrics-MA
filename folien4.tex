...
\newpage
%##########################################
\bfsf{Ausf\"uhrliches Beispiel f\"ur den binomialen Fall:\\
Auswertung einer Umfrage in der Vorlesung}
%##########################################
\vspace{3em}
\begin{center}
...
\newpage
%###################################################
\bfsf{Ergebnisse  I: Likelihood-Funktion des binomialen Logit-Modells}
%###################################################
\vspace{-4em}
\fig{1.2\textwidth}{figsDiscr/BNL_kalib_L.eps}
\vspace{-1.5em}
...
\newpage
%###################################################
\bfsf{Ergebnisse II: Log-Likelihood}
%###################################################
\vspace{-1em}
\fig{1.20\textwidth}{./figsDiscr/BNL_kalib_logL.eps}
\vspace{-1em}
...
\newpage
%###################################################
\bfsf{Ergebnisse  IIa: Log-Likelihood bei mehr
Daten}
%###################################################
\vspace{-1em}
\fig{1.20\textwidth}{./figsDiscr/BNL_kalib_logL10.eps}
\vspace{-1em}
...
\newpage
%###################################################
\bfsf{Ergebnisse  III: Aussage des binomialen Logit-Modells}
%###################################################
\vspace{0em}
...
\newpage
%###################################################
\bfsf{Ergebnisse IV: Sensitivit\"at gegen\"uber Daten\"anderungen}
%###################################################
\vspace{0em}
...
\newpage
%###########################################
\bfsf{Ausf\"uhrliches Beispiel f\"ur den multinomialen Fall:\\
Detailliertere Auswertung der Umfrage}
%###########################################
\vspace{2em}
\begin{center}
\begin{tabular}{|l||c|c|c|c|} \hline
...
\newpage
%###################################################
\bfsf{Nested-Logit Modell am Beispiel ``Shopping''}
%###################################################
\vspace{1em}
...
\newpage
%###################################################
\bfsf{Nichtlineare Nutzenfunktion I: Schwelle: Daten}
%###################################################
\vspace{1em}
...
\newpage
%###################################################
\bfsf{Nichtlineare Nutzenfunktion I: Schwelle: Modellierung}
%###################################################
\vspace{1em}
\fig{1.3\textwidth}{figsDiscr/nonlinUtility_4param.skriptFig.eps}
...
\newpage
%###################################################
\bfsf{Nichtlineare Nutzenfunktion II: Erh\"ohte sSensitivit\"at:  Daten}
%###################################################
\vspace{1em}
...
\newpage
%###################################################
\bfsf{Nichtlineare Nutzenfunktion II: Erh\"ohte Sensitivit\"at: Modell}
%###################################################
\vspace{1em}
\fig{1.3\textwidth}{figsDiscr/nonlinUtility_4param_Tversky.skriptFig.eps}
...
\newpage
%###################################################
\bfsf{Nichtlineare Nutzenfunktion II: Test weitere Modelle}
%###################################################
\vspace{1em}
\fig{1.3\textwidth}{figsDiscr/nonlinUtility_3param2param.eps}


\newpage
%###################################################
\bfsf{Log-Likelihoods des Nested-Logit-Beispiels}
%###################################################
\vspace{1em}

\begin{tabular}{cc}
 \includegraphics[width=0.65\textwidth]{./figsDiscr/nestedLogit_beta1beta2.eps}
&
 \includegraphics[width=0.65\textwidth]{./figsDiscr/nestedLogit_beta3beta4.eps}
\\
