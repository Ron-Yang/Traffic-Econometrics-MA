...
#Daten aus  VkoekSS09_statedChoice.userInput
...
beta0=-1.369496; stddev0=0.471777
beta1=-0.227620; stddev1=0.022451
beta2=-0.194850; stddev2=0.013540
beta3=-1.746932; stddev3=0.116474

#Functional Matrix J
 J00=84.067382;J01=2272.227723;J02=-2984.016877;J03=-44.703230;
 J10=2272.227723;J11=63371.455086;J12=-82026.693789;J13=-1341.096892;
 J20=-2984.016877;J21=-82026.693789;J22=111464.559919;J23=1341.096892;
 J30=-44.703230;J31=-1341.096892;J32=1341.096892;J33=94.709810;
...
set out "VkoekSS09_statedChoice_1.eps"
print "plotting VkoekSS09_statedChoice_1.eps"
...
###############################
set out "VkoekSS09_statedChoice_2.eps"
print "plotting VkoekSS09_statedChoice_2.eps"
###############################
...
plot[t=Kmin:Kmax]\
 ...
 K14, log(h04/h14) t "" w p ls 2 ,\
 K15, log(h05/h15) t "" w p ls 2 ,\
 K16, log(h06/h16) t "" w p ls 2 

###############################
set out "VkoekSS09_statedChoice_3.eps"
print "plotting VkoekSS09_statedChoice_3.eps"
###############################
...
###############################
set out "VkoekSS09_statedChoice_4.eps"
print "plotting VkoekSS09_statedChoice_4.eps"
###############################
...
plot\
  "VkoekSS09_statedChoice.dat" u ($1+1):(hFuss($2,$5)) t "Daten" w lp ls 11,\
  "VkoekSS09_statedChoice.dat" u ($1+1):(hFuss($2,$6)) t "Modell" w lp ls 12


###############################
set out "VkoekSS09_statedChoice_5.eps"
print "plotting VkoekSS09_statedChoice_5.eps"
###############################
...
##############################
set out "VkoekSS09_statedChoice_Lbeta1beta2.eps"
print "plotting VkoekSS09_statedChoice_Lbeta1beta2.eps"
...
##############################
set out "VkoekSS09_statedChoice_Lbeta1beta3.eps"
print "plotting VkoekSS09_statedChoice_Lbeta1beta3.eps"
...
##############################
set out "VkoekSS09_statedChoice_Lbeta2beta3.eps"
print "plotting VkoekSS09_statedChoice_Lbeta2beta3.eps"
...
##############################
set out "VkoekSS09_statedChoice_Lbeta0beta1.eps"
print "plotting VkoekSS09_statedChoice_Lbeta0beta1.eps"
