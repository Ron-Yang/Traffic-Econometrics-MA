...
das \"okonometrische \bfblue{Verflechtungsmodell}, auch
\bfblue{Input-Output-Modell (IOM)} oder nach seinem Begr\"under
Wassily Leontief \bfblue{Leontief-Modell}
...
\item $A_{ij}$ die Elemente  der  \bfblue{Koeffizientenmatrix des direkten
...
\bfblue{Bestandsmassen} oder \bfblue{Bewegungsmassen} zu definieren.
\bi
\item Bewegungsmassen sind nur \"uber Zeit\emph{intervalle} definiert und
nehmen im \bfblue{Flie\3gleichgewicht} linear mit der L\"ange des
...
Die Modellparameter, also die \bfblue{Koeffizienten $A_{ij}$  des
...
\bfblue{Koeffizientenmatrix des vollen Aufwandes} bezeichnet. Die
...
bis maximal f\"ur $n=5$ sinnvoll mit dem \bfblue{Gau\3'schen
...
kombiniert:
\bi
\item Die \bfblue{Lebenszyklusanalyse} bzw. 
\bfblue{Life-Cycle-Assessment (LCA)}, auch \bfblue{\"Oko\-bi\-lanz}
...
\bfblue{Econometric Input-Output LCA (EIO-LCA)} eingebunden.
\ei
...
Vektor $\vec{y}\sup{s}$ der \bfblue{Sachbilanz}.
...
Meist wird hier nicht direkt CO$_2$,
  sondern das sogenannte \bfblue{CO$_2$-\"Aquivalent} angegeben. Dabei
...
die
\bfblue{Tank-to-Wheel} Emissionen, multipliziert mit der Laufleistung
...
Sektoren abzubilden, ist auch eine \bfblue{produktbezogene
...
Reparatur-Dienstleistungen, was hier als \bfblue{erweiterte Sachbilanz}
bezeichnet wird.
...
\bfblue{Supply-Chain-Modell} genannt wird:
\be
