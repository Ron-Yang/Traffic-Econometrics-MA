...
\bdm
U_i=U(\underbrace{\vec{C}_i, \vec{S}}_{\rm known}, 
          \underbrace{\vec{C}'_i, \vec{S}'}_{\rm unknown})
...
\bdm
U_i=U(\vec{C}_i \underbrace{+\vec{\epsilon}_i}_{\rm measuring\ error}, 
  \vec{S} \underbrace{+\vec{\epsilon}}_{\rm measuring\ error})
