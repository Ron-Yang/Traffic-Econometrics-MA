...
% Questions: 
% *. time scale ofexp growth for SI, SIR, SIRM models for S->1
% 1. SIRM for S=1
% timescale iterated SIRM
...
\placebox{0.50}{0.38}
 {\parbox{0.8\textwidth}{
  \bi
    \item 1a.1 Simple Macroscopic Models (SI, SIR, SEIR, SIRM)
    \item 1a.2 Microscopic Models
    \item 1a.3 Down to Earth: Data-Related Issues
    \item 1a.4 Simulation \texttt{Corona-simulation.de}
  \ei
}}
