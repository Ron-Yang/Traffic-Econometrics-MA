...
\providecommand{\bfdef} [1]{\hspace*{0.01em}{\boldmath \textbf \blue{#1}}}
...
%arne:
%\providecommand{\bfdef}[1]{\textbf{\blue{#1}}}
%\providecommand{\bfblack}[1]{\textbf{\black{ #1}}}
%\providecommand{\bfgreen}[1]{\textbf{\green{#1}}}
%\providecommand{\bfred}[1]{\textbf{\red{#1}}}



\providecommand{\bfsf}[1]{{\large\textsf\textbf{#1}}}
\providecommand{\bfsfc}[1]{\begin{center}{\large\textsf\textbf{#1}}\end{center}}
\providecommand{\secfont}[1]{{\Large\textsf\textbf{#1}}}
...
\providecommand{\m}[1]{\text{\textsf\textbf{#1}}}         %Matrix
\providecommand{\mgr}[1]{\text{\boldmath {$#1$}}}        %Matrix fuer griech. Buchs (sigma)
%\providecommand{\m}[1]{\mbox{\textsf\textbf{#1}}}  %Matrix=fett+gerade(nicht griech. Zeichen!)
