...
% only backwards compatibility; now \euro{zahl},\euro{}
\providecommand{\Eur}{\mbox{ \hspace{-0.4em} 
$C\!\!\!\!\!\!$ \parbox{2mm}{ \vspace*{-0.5mm}
    {\scriptsize =}} \ }}  
...
\newcommand{\OK}{\includegraphics[width=8mm]
   {figsGeneric/OK.eps}}
\newcommand{\contradiction}{
  \parbox{1.2em}{\vspace*{-0.2em}
  \includegraphics[width=0.9em, origin=br]
   {../figsGeneric/contradiction.eps}\vspace*{0.2em}}
}
...
\newcommand{\circlei}{
  ...
  \includegraphics[width=1.2em, origin=br]
   {figsGeneric/1circle.eps}\vspace*{0.2em}}
}

\newcommand{\circleii}{
  \parbox{1.2em}{\vspace*{-0.2em}
  \includegraphics[width=1.2em, origin=br]
   {figsGeneric/2circle.eps}\vspace*{0.2em}}
}

\newcommand{\circleiii}{
  \parbox{1.2em}{\vspace*{-0.2em}
  \includegraphics[width=1.2em, origin=br]
   {figsGeneric/3circle.eps}\vspace*{0.2em}}
}

\newcommand{\circleiv}{
  \parbox{1.2em}{\vspace*{-0.2em}
  \includegraphics[width=1.2em, origin=br]
   {figsGeneric/4circle.eps}\vspace*{0.2em}}
}

\newcommand{\circlev}{
  \parbox{1.2em}{\vspace*{-0.2em}
  \includegraphics[width=1.2em, origin=br]
   {figsGeneric/5circle.eps}\vspace*{0.2em}}
}
