...
\item 8.3 Example: SP Survey in the Audience
\item 8.4 Elasticities
\bi
\item 8.4.1 Microscopic
\item 8.4.2 Macroscopic
\ei
\ei
}
}}
...
%##############################################################
\frame{\frametitle{8.3 Example: SP Survey in the Audience WS18/19 
...
\subsection{8.4 Elasticities}

%###################################################
\frame{\frametitle{8.4 Elasticities}
%###################################################
...
\subsubsection{8.4.1 Microscopic Elasticities}

%###################################################
\frame{\frametitle{8.4.1 Microscopic Logit elasticities}
%###################################################
...
\
subsubsection{8.4.2 Macroscopic Elasticities}

%###################################################
\frame{\frametitle{8.4.2 Macroscopic elasticities}
%###################################################
