...
Probanden in einem \bfblue{Pre-Test} gepr\"uft, ob die Erhebung so
...
Untersuchung der relevanten Merkmale (\bfblue{makroskopische Ebene})
bis hin zur Ber\"ucksichtigung einzelner Merkmalstr\"ager
bzw. Individuen (\bfblue{mikroskopische Ebene}).  Den Spezialfall einer
Disaggregierung makroskopischer Daten nach Altersgruppen bezeichnet
man auch als \bfblue{Kohortendesign}. 
...
\bi
\item
\bfblue{Querschnittsdaten} werden zu einem festen Zeitpunkt oder
...
\item
Bei \bfblue{L\"angsschnittdaten} hingegen wird auch die Ver\"anderung
in der Zeit ber\"ucksich\-tigt. Dies kann in Form mehrerer
Querschnitterhebungen (\bfblue{Trend-Design}) erfolgen, welche in Zeitabst\"anden
...
man von \bfblue{Paneldaten}.\footnote{Die daran beteiligten Personen bezeichnet
...
kontinuierlich \"uber die Zeit auf, spricht man von einer \bfblue{Zeitreihe}.
\ei

\subsection{Ausma\3 der Kontrolle \"uber den Untersuchungsgegenstand}

\bi
\item \bfblue{Objektive Messung}. Die Daten werden hier
...
\item \bfblue{Erhebung tats\"achlicher Ereignisse durch
...
\item \bfblue{Experientelles Design: Direkte Nutzermessung}
...
\item \bfblue{Kombiniertes Design}
Hier werden Revealed-Choice Daten als Angelpunkt oder
\bfblue{Pivot} einer Stated-Choice Befragung derselben Personen
...
\bfblue{statistische Gesamtheit}
bzw.\bfblue{Grund\-gesamtheit} 
definieren. Dies geschieht (vgl. Statistik-Grundvorlesung) durch 
\bi
\item \bfblue{r\"aumliche Eingrenzung} (z.B. Untersuchungsgebiet
Deutschland oder Dresden),
\item \bfblue{zeitliche Eingrenzung} (Zeitpunkt oder Zeitraum,
z.B. Sommer 2008)
\item \bfblue{sachliche Eingrenzung} (z.B. nur erwachsene Personen,
...
\bi
\item Die \bfblue{Ziehungsgrundlage}. Diese ist bei objektiven Messungen eine
...
\item 
\bfblue{Vollerhebung} oder \bfblue{Stichprobe}. Vollerhebungen sind extrem aufw\"andig
und kommen (abgesehen von der Volksz\"ahlung) nur f\"ur kleine
statistische Gesamtheiten in Frage. Bei der Stichprobe wiederum
unterscheidet man im Wesentlichen die \bfblue{Zufallsauswahl}, die
\bfblue{Proportionalauswahl} (geschichtete Stichprobe)  und die \bfblue{Klumpenauswahl}
\ei
...
\bfblue{Messquerschnitten}\footnote{Manchmal werden auf diese Weise
...
\bi
\item \bfblue{pneumatische Z\"ahler}: 
Vor allem Stadtverkehr als  tempor\"are Anwendung,
\item  \bfblue{Induktionsschleifen} oder Infrarot-Messung: 
...
auch als \bfblue{Tagesganglinie}. Nat\"urlich h\"angt
...
damit die sogenannte \bfblue{Bemessungsverkehrsst\"arke} als Quantil
der Verkehrsnachfrageverteilung definieren
(vgl. Abb. \ref{fig:bemessungsverkehrsstaerke}): 

\maintext{Die  \bfblue{Bemessungsverst\"arke} einer Richtungsfahrbahn 
...
Dresden (Prof. Ahrens) durch\-gef\"uhrten Erhebung \bfblue{System relevanter
...
Die \bfblue{Modalit\"at der Erhebung} ist entweder ein
...
\bi
\item \bfblue{Allgemeine soziodemografische und sozio\"okonomische
...
\item \bfblue{Mobilit\"atsbezogene sozio\"okonomische Merkmale}:
...
\item \bfblue{Aktivit\"atenbezogene Merkmale}: Zahl der Wege
...
erhoben.
\item \bfblue{Wege- bzw. alternativenbezogene Merkmale}: Start und
...
\bfblue{revealed preference}, also ``aufge\-deck\-te Pr\"aferenzen'' (bei
...
drei Varianten dieser auch als  \bfblue{experimentelles Design}
bekannten Versuchsanordnung: 
\bi
\item[(a)] \bfblue{Stated preference}. Verschiedene Alternativen oder
...
\item[(b)] \bfblue{Stated ranking}. Hier werden
...
\item[(c)] \bfblue{Stated choice}. Hier wird nur nach der besten aus
...
\bfblue{Conjoint-Analyse} (Akronym aus dem Englischen:
...
Conjoint-Analyse, die \bfblue{wahlbasierte Conjoint-Analyse}, relevant. Dabei
...
Alternative abgefragt wird. In jeder Alternativenmenge (engl. \bfblue{\emph{choice
...
Kapitel~\ref{sec:choice} vorgestellten \bfblue{diskreten Wahltheorie}
analysiert.
...
Kapitel \ref{sec:choice} besprochenen \bfblue{Diskreten Wahltheorie}
...
Regressionsmodellen, nur dass der i.i.d. \bfblue{Zufallsnutzen} $\epsilon_k$
...
\ei
%
F\"ur die Erstellung der \bfblue{deterministischen} Nutzenfunktionen $V_k$ und die
Erhebung der geeigneten Merkmale gelten deshalb folgende Prinzipien:
\bi
\item \bfblue{Translationsinvarianz}: Man kann zu den
  Nutzenfunktionen aller Alternativen 
einen festen Wert hinzuaddieren, ohne dass sich das
  Ergebnis  \"andert.
\item \bfblue{Skaleninvarianz}: Wegen dem Prinzip \emph{the winner takes
...
gegen\"uber der \bfblue{Referenzalternative} \"OV in Nutzeneinheiten
(NE),
...
\ei
Wir haben hier die Zeitsensitivit\"at \bfblue{alternativenspezifisch}
formuliert, also unter\-schied\-liche Sensitivit\"aten f\"ur Fu\3/Rad und
\"OV. Man k\"onnte sie auch \bfblue{generisch} mit einer
...
\noindent
\bfblue{Vollst\"andige Enumeration 
...
\noindent
\bfblue{Orthogonales Design}: Die Merkmalskombinationen werden so
...
\noindent
\bfblue{Effizientes Design}: Dies ist die einzige Strategie, bei der
...
$n=10$ immerhin $\ueber{10}{100} > 10^{12}$)
 ...
 \bfblue{D-errors} (\emph{determinantenbasierte Ungenauigkeit})
\be
\label{D-error}
