...
% ACHTUNG Referenz bei ~/tex/inputs/desfsSkript.tex
...
\providecommand{\bfsflarge}  [1]{{\large\sf\textbf{#1}} \vspace{0.4em}}
\providecommand{\bfsfLarge}  [1]{{\Large\sf\textbf{#1}} \vspace{0.4em}}
...
\providecommand{\m}[1]{\text{\sf\textbf{#1}}} %Matrix=fett+gerade(nicht gr)
