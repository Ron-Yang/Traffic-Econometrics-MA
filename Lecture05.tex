...
%###################################################
\frame{\frametitle{Continuous parameter II}
%###################################################
...
\subsection*{Example: Gaussian Prior Distribution and Observations}
...
\subsection{x.x. Logistic regression}

%###################################################
\frame{\frametitle{x.x. Logistic regression}
%###################################################
