...
##################################################################
set out "PH0post_b_PriorProb0.5.eps"
print   "plotting PH0post_b_PriorProb0.5.eps"
##################################################################

#set term post eps enhanced color solid "Helvetica" 16
set term post eps enhanced color dashed "Helvetica" 16

set noparam
set key right top box
strTitle(PH0)=sprintf("binaer verteilte wahre Werte mit A-Priori-Wahrscheinlichkeit\
 P(H_0)=%1.4f", PH0)
set xlabel "GPS-Messung b/d (0=Autobahn, 1=Landstrasse)"
set ylabel "A-Posteriori Wahrscheinlichkeit von H0: \"Autobahn\""
set label 1 at screen 0.15,0.20
set label 2 at screen 0.15,0.15
...
plot[r=0:1]\
 PH0post(d*r, 0.2, d, PH0) t "{/Symbol s}_b/d=0.2" w l ls 1,\
 PH0post(d*r, 0.3, d, PH0) t "{/Symbol s}_b/d=0.3" w l ls 2,\
 PH0post(d*r, 0.5, d, PH0) t "{/Symbol s}_b/d=0.5" w l ls 3,\
 PH0post(d*r, 1.0, d, PH0) t "{/Symbol s}_b/d=1.0" w l ls 5

##################################################################
set out "PH0post_b_PriorProb0.8.eps"
print   "plotting PH0post_b_PriorProb0.8.eps"
##################################################################
PH0=0.8
set title strTitle(PH0)
plot[r=0:1]\
...
##################################################################
set out "PH0post_p_PriorProb0.5.eps"
print   "plotting PH0post_p_PriorProb0.5.eps"
##################################################################
...
plot[p=0:0.5]\
 PH0post(b(p,sigb), sigb, 50, PH0) t "{/Symbol s}_b/d=0.2" w l ls 1,\
 PH0post(b(p,sigb), sigb, 33, PH0) t "{/Symbol s}_b/d=0.3" w l ls 2,\
 PH0post(b(p,sigb), sigb, 20, PH0) t "{/Symbol s}_b/d=0.5" w l ls 3,\
 PH0post(b(p,sigb), sigb, 10, PH0) t "{/Symbol s}_b/d=1.0" w l ls 5,\
 PH0post(b(p,sigb), sigb, 5, PH0)  t "{/Symbol s}_b/d=2.0" w l ls 6,\
 PH0post(b(p,sigb), sigb, 2, PH0)  t "{/Symbol s}_b/d=5.0" w l ls 7

##################################################################
set out "PH0post_p_PriorProb0.8.eps"
print   "plotting PH0post_p_PriorProb0.8.eps"
##################################################################
PH0=0.8
sigb=10.
d=50.
