...
min(x,y)    = (x>y) ? y : x
 ...
 ############################
 # Gauss-Distributionen and Derivate
 ############################
...
phiQuantil(q)=invnorm(q)
 ...
 ############################
 # Student-t-Distribution  and Derivate, nu=Zahl of the DOF
 ############################
...
#Test
p=0.999; nu=2; t0=nu
print "\nTest tQuantil and chi2Quantil fuer p=",p," nu=",nu
...
print "beta0=",beta0,": t-Value=",t0," p-Value=",p0
print "beta1=",beta1,": t-Value=",t1," p-Value=",p1
print "beta2=",beta2,": t-Value=",t2," p-Value=",p2
...
print "epsilon1 echtem Value: epsilon1=",epsilon1
print "epsilon1 Value of the Aufgabenstellung: x1bar/ybar*0.05=",x1bar/ybar*0.05
...
print "V11=",V11
print "V22=",V22
print "t1Test=",t1Test," beta-Value aus Aufgabenstellung: t1_aufg=",t1Test_betaAufg
print "t2Test=",t2Test," beta-Value aus Aufgabenstellung: t2_aufg=",t2Test_betaAufg
print "beta1=",beta1,": t-Value=",t1," p-Value=",p1
print "beta2=",beta2,": t-Value=",t2," p-Value=",p2
