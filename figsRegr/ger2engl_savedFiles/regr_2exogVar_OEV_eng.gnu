...
#########################################################
print ""
print "Mittelwerte, Varianz- and Kovarianzmatrizen"
print "====================================="
#########################################################
...
print "\nHalbe Breiten der KI and KI selbst bei Modellen mit nur x1 bzw. x2:"
...
plot\
 ...
 student(x,1) t "Student-Distribution mit {/Symbol n}=1 FG" w l ls 2,\
 student(x,2) t "Student-Distribution mit {/Symbol n}=2 FG" w l ls 3
...
plot[x=xnormmin:xnormmax]\
 ...
 x,studentCum(x,1) t "Student-Distribution mit {/Symbol n}=1 FG" w l ls 2,\
 x,studentCum(x,2) t "Student-Distribution mit {/Symbol n}=2 FG" w l ls 3,\
 x,0.95 t "" w l ls 99,\
