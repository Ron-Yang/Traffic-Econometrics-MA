...
set style line 21 lt 1 lw 20 pt 7 ps 0.8  lc rgb "#000000" #schwarz,solid,bullet
...
xlimited(x)       =(x<-5) ? -5 : ( (x>5) ? 5 : x)
  ...
  # Normierte Density der Standardnormalverteilung

gauss(mu,sigma,x) = exp(-(x-mu)**2/(2* sigma**2)) / (sigma*sqrt(2*pi))

  # (kum) Distribution Function der Standardnormalverteilung
...
# 2d-Densityn (bei Student einfach jede Koordinate as student(1d)+Korrel.
#  transformiert)
...
# Klassische Varianz-Kovarianz matrix exog-exog and Kov-Vektor exog-endog
...
print "Halbe Breiten der KI and KI selbst:"
print "beta0=",beta0
...
print "======================================"
t0=beta0/sqrt(covbeta00)
t1=beta1/sqrt(covbeta11)
t2=beta2/sqrt(covbeta22)
...
print "======================================"
print "H0: beta1<0, p1=1-studentCum(t1,n-3)=", 1-studentCum(t1,n-3)
print "H0: beta2>0, p1=studentCum(t2,n-3)=", studentCum(t2,n-3)
...
print "\nAsymmetrischer Test auf beta2<-1.0: t- and p-Valuee"

#########################################################
c=30.
print "\nKombi-Test auf beta1<-c*beta2 bzw. GamH0=beta1+c*beta2<0, c=",c,": t- and p-Valuee"
erwGamH0=beta1+c*beta2
varGamH0=covbeta11+2*c*covbeta12+c**2*covbeta22
tGamH0=erwGamH0/sqrt(varGamH0)
print "c=",c," erwGamH0=",erwGamH0," varGamH0=",varGamH0
...
#########################################################
print "\nConfidence Intervals der Linearkombination GamH0=beta2+c beta1"
print "======================================"
#########################################################

c1=dbeta2/dbeta1
c2=-dbeta2/dbeta1
erwGamH01=beta2+c1*beta1
erwGamH02=beta2+c2*beta1
varGamH01=covbeta22 + c1**2*covbeta11+2*c1*covbeta12
varGamH02=covbeta22 + c2**2*covbeta11+2*c2*covbeta12
dGamH01=t_nm3_0975*sqrt(varGamH01)
dGamH02=t_nm3_0975*sqrt(varGamH02)
print "GamH01=beta2+c1*beta1 = beta2 +dbeta2/dbeta1*beta1"
print "GamH02=beta2+c2*beta1 = beta2 -dbeta2/dbeta1*beta1"
print "Halbe Breiten von KI(GamH01/2) and KI(GamH01/2) selbst"
print "dGamH01=",dGamH01,"   KI(GamH01)=[",erwGamH01-dGamH01,",",erwGamH01+dGamH01,"]"
print "dGamH02=",dGamH02,"   KI(GamH02)=[",erwGamH02-dGamH02,",",erwGamH02+dGamH02,"]"
...
print " Es verbleibt Fmin/(n-3)=",Fmin/(n-3)," Errorquadratsumme pro FG"
...
##############################
beta103=30.
beta203=-0.6  # NICHT Uebung; dort beta20=-0.5
...
covbeta11_M1 = 1./n * sig2_est_M1/s11
covbeta22_M2 = 1./n * sig2_est_M2/s22
...
#######################################
print "plotting hotel_Ftest_eng.eps"
set out "hotel_Ftest_eng.eps"
#######################################
set param
set key bottom left
set xlabel "f"
...
#######################################
print "plotting hotel_f_hatbeta1_eng.eps"
set out "hotel_f_hatbeta1_eng.eps"
#######################################
...
#######################################
print "plotting hotel_f_hatbeta2_eng.eps"
set out "hotel_f_hatbeta2_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x1x2_eng.eps"
set out "hotel_scatterplot_x1x2_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x1y_eng.eps"
set out "hotel_scatterplot_x1y_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x2y_eng.eps"
set out "hotel_scatterplot_x2y_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x2ycondx1_eng.eps"
set out "hotel_scatterplot_x2ycondx1_eng.eps"
#######################################
min1=17
max1=42
min2=30
...
#######################################
print "plotting hotel_scatterplot_x2ycondx1_notCal1_eng.eps"
set out "hotel_scatterplot_x2ycondx1_notCal1_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x2ycondx1_notCal2_eng.eps"
set out "hotel_scatterplot_x2ycondx1_notCal2_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x2ycondx1_notCal3_eng.eps"
set out "hotel_scatterplot_x2ycondx1_notCal3_eng.eps"
#######################################
...
#######################################
print "plotting hotel_scatterplot_x2ycondx1_notCal4_eng.eps"
set out "hotel_scatterplot_x2ycondx1_notCal4_eng.eps"
#######################################
...
#######################################
print "plotting hotel_f2_hatbeta1_hatbeta2_eng.eps"
set out "hotel_f2_hatbeta1_hatbeta2_eng.eps"
#######################################
...
#     lines produce unreproducible/illogical bugs => points
# BUG surface necessary but produces huge files for reasonable sampling=>png
set isosamples 100  # because of points

splot[t=0:1]\
 beta1-dbeta1, ymin+t*(ymax-ymin),10\
      t "Confidence Intervals T-Test {/Symbol b_1, b_2}" w p ls 16,\
 beta1+dbeta1, ymin+t*(ymax-ymin),0 t "" w p ls 16,\
 xmin+t*(xmax-xmin), beta2-dbeta2,0 t "" w p ls 16,\
 xmin+t*(xmax-xmin), beta2+dbeta2,0 t "" w p ls 16,\
 xminGamH0+t*(xmax-xminGamH0), erwGamH01-c1*(xminGamH0+t*(xmax-xminGamH0))-dGamH01,0\
   t "Confidence Intervals T-Test {/Symbol g}_1, {/Symbol g}_2" w p ls 12,\
 xminGamH0+t*(xmax-xminGamH0), erwGamH01-c1*(xminGamH0+t*(xmax-xminGamH0))+dGamH01,0\
   t "" w p ls 12,\
 xminGamH0+t*(xmax-xminGamH0), erwGamH02-c2*(xminGamH0+t*(xmax-xminGamH0))-dGamH02,0\
   t "" w p ls 12,\
 xminGamH0+t*(xmax-xminGamH0), erwGamH02-c2*(xminGamH0+t*(xmax-xminGamH0))+dGamH02,0\
   t "" w p ls 12,\
 20+30*1.2*t,-2./3. -1.2*t,0 t "Bounds Test {/Symbol b_1 + 30 b_2}<0" w p ls 21
...
splot[t=0:1]\
  beta101,beta20,0.01 t "Compound Null Hypothesis H_{01}" w p ls 1,\
...
FminNull=sumyNullyNull-n*betaNull**2
Fmin=n*s_epseps
f_realis=(FminNull-Fmin)/Fmin * (n-3.)/(3.-1.)
print  "\nUebung: beta10=",beta10," beta20=",beta20,":"
print " Fmin=", Fmin," FminNull=",FminNull," f_realis3=",f_realis3
print " p-Value=1-fisherCum(f_realis3,2,n-3)=",1-fisherCum(f_realis3,2,n-3)


#######################################
print "plotting hotel_f2_hatbeta1_hatbeta2_uebung_eng.eps"
set out "hotel_f2_hatbeta1_hatbeta2_uebung_eng.eps"
#######################################
...
set pm3d
unset clabel
set cntrparam levels discrete 0.03  # eine Contour!
...
splot[t=0:1]\
  beta10,beta20,0.01 t "Compound Null Hypothesis" w p ls 1
...
#######################################
print "plotting hotel_f2_hatbeta1_hatbeta2_simple_eng.eps"
set out "hotel_f2_hatbeta1_hatbeta2_simple_eng.eps"
#######################################
...
#######################################
print "plotting hotel_fisherCum_eng.eps"
set out "hotel_fisherCum_eng.eps"
#######################################
unset colorbox
set term post eps enhanced color solid "Helvetica" 20
set size 1,0.7
...
#######################################
print "plotting hotel_fisherCumSolved_eng.eps"
set out "hotel_fisherCumSolved_eng.eps"
#######################################
set size 1,0.7
set key at screen 0.6,0.2
plot[f=fmin:fmax]\
 f, fisherCum(f,2,n-3) t "" w l ls 12,\
 f_realis, 0.55+0.45*(f-fmin)/(fmax-fmin) t "realisierter Value" w l ls 17



#######################################
print "plotting hotel_studentCum_eng.eps"
set out "hotel_studentCum_eng.eps"
#######################################
set term post eps enhanced color solid "Helvetica" 20
set size 1,0.7
tmin=1
...
#######################################
print "plotting hotel_studentCumSolved_eng.eps"
set out "hotel_studentCumSolved_eng.eps"
#######################################
...
print "t1=",t1," t2asym=",t2asym


#######################################
print "plotting hotel_scatter3d_1_eng.eps"
set out "hotel_scatter3d_1_eng.eps"
#######################################
set term post eps enhanced color solid "Helvetica" 18
set nogrid
unset colorbox
...
#######################################
print "plotting hotel_scatter3d_2_eng.eps"
set out "hotel_scatter3d_2_eng.eps"
#######################################
...
#######################################
print "plotting hotel_SSE_eng.eps"
set out "hotel_SSE_eng.eps"
#######################################
