...
# Data 
# x=kilometer
# f=Anteil PT/Car bei RC-Umfrage WS 2014/2015
...
n1=6.; x1=0.5; f1=2./3.;   ys1=ystar(f1)
n2=4.; x2=1.5; f2=0.5;  ys2=ystar(f2)
n3=5.; x3=2.5; f3=0.8; ys3=ystar(f3)
n4=8.; x4=4.0; f4=0.999999; ys4=ystar(f4)
n5=3.; x5=7.5; f5=0.999999;  ys5=ystar(f5)  # n=5 als Demo fuer Ungeeignetheit

#######################################
print "plotting regr_logistic_WSWS1516_eng.eps"
set out "regr_logistic_WSWS1516_eng.eps"
#######################################
...
#######################################
print "plotting regr_logistic_WSWS1516_f_eng.eps"
set out "regr_logistic_WSWS1516_f_eng.eps"
#######################################
