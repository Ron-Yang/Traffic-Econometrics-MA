...
xlimited(x)       =(x<-5) ? -5 : ( (x>5) ? 5 : x)
  ...
  # integral der Standard Normal Distribution
phi(x)            =norm(x)
phiOld(x)            =0.5*(erf(xlimited(x/sqrt(2)))+1)  #equivalent
                
 # Quantil der Standard Normal Distribution
...
# "klassische" Kovarianzmatrix der "richtigen" Variablen x1,x2 and Kovarianzvektor y
...
#########################################################
print "\nConfidence Intervals der Linearkombination U=beta2+c beta1"
print "======================================"
#########################################################
...
#######################################
print "plotting weglaenge_Ftest_eng.eps"
set out "weglaenge_Ftest_eng.eps"
#######################################
set param
set key bottom left
set xlabel "f"
...
#######################################
print "plotting weglaenge_f_hatbeta1_eng.eps"
set out "weglaenge_f_hatbeta1_eng.eps"
#######################################
...
#######################################
print "plotting weglaenge_f_hatbeta2_eng.eps"
set out "weglaenge_f_hatbeta2_eng.eps"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x1x2_eng.eps"
set out "weglaenge_scatterplot_x1x2_eng.eps"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x1y_eng.eps"
set out "weglaenge_scatterplot_x1y_eng.eps"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x2y_eng.eps"
set out "weglaenge_scatterplot_x2y_eng.eps"
#######################################
...
#######################################
print "plotting weglaenge_f2_hatbeta1_hatbeta2_eng.eps"
set out "weglaenge_f2_hatbeta1_hatbeta2_eng.eps"
#######################################
...
set pm3d
unset clabel
#set title "2d-Density der {/Symbol b}-Sch \344tzer unter H_0: {/Symbol s} and {/Symbol b}_j as gemessen"
...
#######################################
print "plotting weglaenge_scatter3d_1_eng.eps"
set out "weglaenge_scatter3d_1_eng.eps"
#######################################
set nogrid
unset colorbox
...
#######################################
print "plotting weglaenge_scatter3d_2_eng.eps"
set out "weglaenge_scatter3d_2_eng.eps"
#######################################
