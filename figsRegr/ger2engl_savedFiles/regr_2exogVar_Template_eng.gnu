...
#########################################################
print "\nAsymmetrischer Test auf beta2<-1.5: t- und p-Werte"
beta20=-1.5
t2asym=(beta2-beta20)/sqrt(covbeta22)
p2asym=1*(1-studentCum(t2asym,n-3))
print "beta2asym: t-Wert=",t2asym," p-Wert=",p2asym
print "\nAsymmetrischer Test auf beta2<-1.0: t- und p-Werte"

#########################################################
c=30.
print "\nKombi-Test auf beta1<-c*beta2 bzw. GamH0=beta1+c*beta2<0, c=",c,": t- und p-Werte"
...
#########################################################
print "\nKonfidenzintervalle der Linearkombination GamH0=beta2+c beta1"
print "======================================"
#########################################################
...
print "Halbe Breiten von KI(GamH01/2) und KI(GamH01/2) selbst"
...
print " p-Wert=1-fisherCum(f_realis2,2,n-3)=",1-fisherCum(f_realis2,2,n-3)
...
print " p-Wert=1-fisherCum(f_realis3,2,n-3)=",1-fisherCum(f_realis3,2,n-3)
...
plot[t=0:1]\
  ...
  f_realis1, t\
   t "Realisierter f-Wert bei {/Symbol b}_{10}=30,{/Symbol b}_{20}=-1" w l ls 17,\
  f_realis2, t\
...
splot[t=0:1]\
 beta1-dbeta1, ymin+t*(ymax-ymin),10\
      t "Konfidenzintervalle T-Test {/Symbol b_1, b_2}" w p ls 16,\
 ...
 xminGamH0+t*(xmax-xminGamH0), erwGamH01-c1*(xminGamH0+t*(xmax-xminGamH0))-dGamH01,0\
   t "Konfidenzintervalle T-Test {/Symbol g}_1, {/Symbol g}_2" w p ls 12,\
 xminGamH0+t*(xmax-xminGamH0), erwGamH01-c1*(xminGamH0+t*(xmax-xminGamH0))+dGamH01,0\
   t "" w p ls 12,\
 ...
 xminGamH0+t*(xmax-xminGamH0), erwGamH02-c2*(xminGamH0+t*(xmax-xminGamH0))+dGamH02,0\
   t "" w p ls 12,\
 20+30*1.2*t,-2./3. -1.2*t,0 t "Grenze Test {/Symbol b_1 + 30 b_2}<0" w p ls 21
...
splot[t=0:1]\
  beta10,beta20,0.01 t "Verbundene Nullhypothese" w p ls 1
...
plot[f=fmin:fmax]\
 f, fisherCum(f,2,n-3) t "" w l ls 12,\
 f_realis, 0.55+0.45*(f-fmin)/(fmax-fmin) t "realisierter Wert" w l ls 17
