...
# Streamlined im Vgl for Matrix1
...
set style line 21 lt 1 lw 10 pt 7 ps 1.9  lc rgb "#000000" #schwarz,solid,bullet
...
#set term pngcairo notransparent medium font "Helvetica, 12"
set term pngcairo enhanced color notransparent font "Helvetica, 12"
...
# nur Pseudo, um danach Summen nicht aendern for muessen
x111=0.;		x211=0;		y11=0;
x112=0.;		x212=0;		y12=0;
...
# "klassische" Kovarianzmatrix of the "richtigen" Variablen x1,x2 and Kovarianzvektor y
...
beta1Test=(s1y*s22-s2y*s12)/(s11*s22-s12**2) # klass Methode
...
print "\nCovarianzmatrix  hatsig_epseps*(X'X)^{-1} of the beta-Schaetzer"
...
#######################################
print "plotting weglaenge_Ftest_eng.png"
set out "weglaenge_Ftest_eng.png"
#######################################
set param
set key bottom left
set xlabel "f"
...
set xrange [0:xmax]
plot[t=0:1]\
  xmax*t, fisherCum(xmax*t,2,n-3)\
    t "Cumulated Fisher-Distribution" w l ls 12,\
  f_realis1, t\
   t "Realized f-Value bei {/Symbol b}_{10}=0,{/Symbol b}_{20}=0" w l ls 17,\
  t*xmax, 0.95 t "F=0.95" w l ls 1
#  f_realis2, t\
#   t "Realized f-Value bei {/Symbol b}_{10}=34,{/Symbol b}_{20}=-1" w l ls 15,\

#######################################
print "plotting weglaenge_f_hatbeta1_eng.png"
set out "weglaenge_f_hatbeta1_eng.png"
#######################################
...
set sample 300 # circumvent f... bug with thick line endings
...
#######################################
print "plotting weglaenge_f_hatbeta2_eng.png"
set out "weglaenge_f_hatbeta2_eng.png"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x1x2_eng.png"
set out "weglaenge_scatterplot_x1x2_eng.png"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x1y_eng.png"
set out "weglaenge_scatterplot_x1y_eng.png"
#######################################
...
#######################################
print "plotting weglaenge_scatterplot_x2y_eng.png"
set out "weglaenge_scatterplot_x2y_eng.png"
#######################################
...
#######################################
print "plotting weglaenge_f2_hatbeta1_hatbeta2_eng.png"
set out "weglaenge_f2_hatbeta1_hatbeta2_eng.png"
#######################################
...
set pm3d
unset clabel
#set title "2d-Density of the {/Symbol b}-Sch \344tzer unter H_0: {/Symbol s} and {/Symbol b}_j as gemessen"
...
#       t "Confidence Region t-Test" w l ls 15,\
...
#######################################
print "plotting weglaenge_scatter3d_1_eng.png"
set out "weglaenge_scatter3d_1_eng.png"
#######################################
set nogrid
unset colorbox
...
set contour surface
#set cntrparam bspline
#unset cntrparam; set cntrparam levels 0 
unset clabel
...
#######################################
print "plotting weglaenge_scatter3d_2_eng.png"
set out "weglaenge_scatter3d_2_eng.png"
#######################################
...
detS=s11*s22-s12**2
beta1=(s1y*s22-s2y*s12)/detS# klass Methode
