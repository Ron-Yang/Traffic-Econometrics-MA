...
set style line 3 lt 8 lw 5 pt 3 ps 1.5 #blassrot, offener star
...
############################
 # Chi-Quadrat-Distribution and Derivate, nu=Zahl of the DOF
 ############################
...
# Guetefunktionen fuer parametr. Tests auf Mittelwert sigma2=bekannt

alpha=0.05  # Errorwahrcheinlichkeit
m=2       # Zahl of the freiheitsgrade of the Student-t-Distribution
m_chi2=5   # Zahl of the freiheitsgrade of the chi^2-Distribution
...
plot[t=0:1]\
 0, GfunEqGauss(0,alpha) t "{/Symbol a}-Error" w p ls 5,\
 0.1+t*(zmax-0.1), 1-GfunEqGauss(0.1+t*(zmax-0.1),alpha)\
      t "{/Symbol b}-Error" w l ls 2,\
 -0.1+t*(zmin+0.1), 1-GfunEqGauss(-0.1+t*(zmin+0.1),alpha)\
      t "" w l ls 2,\
 zmin+t*(zmax-zmin), GfunEqGauss(zmin+t*(zmax-zmin),alpha)\
        t "Power Function" w l ls 7

#############################################
set out "fehler12art_eqStudent_2FG_eng.eps"
print "plotting fehler12art_eqStudent_2FG_eng.eps"
#############################################
...
set out "fehler12art_leGauss_eng.eps"
print "plotting fehler12art_leGauss_eng.eps"
set key left top
...
#############################################
set out "fehler12art_leStudent_2FG_eng.eps"
print "plotting fehler12art_leStudent_2FG_eng.eps"
#############################################
...
set key right
set out "fehler12art_geGauss_eng.eps"
print "plotting fehler12art_geGauss_eng.eps"
...
#############################################
set out "fehler12art_geStudent_2FG_eng.eps"
print "plotting fehler12art_geStudent_2FG_eng.eps"
#############################################
...
set out "fehler12art_eqChi2_5FG_eng.eps"
print "plotting fehler12art_eqChi2_5FG_eng.eps"
set key center center
set label 1 "5 DOF" at screen 0.7,0.21
...
plot[t=0:1]\
 1, GfunVarEqual(1,alpha,m_chi2) t "{/Symbol a}-Error" w p ls 5,\
...
set out "fehler12art_leChi2_5FG_eng.eps"
print "plotting fehler12art_leChi2_5FG_eng.eps"
set key left top
...
set out "fehler12art_geChi2_5FG_eng.eps"
print "plotting fehler12art_geChi2_5FG_eng.eps"
