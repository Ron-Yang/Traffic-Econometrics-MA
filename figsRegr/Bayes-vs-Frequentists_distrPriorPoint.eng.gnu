...
set xlabel "GPS measurement b/d (0: freeway, 1: parallel road)" offset 0,0.5
set ylabel "A posteriori probability P(H_0|hat({/Symbol b}))" offset 1,0
#set label 1 "Binary variable  {/Symbol b}=0 (H_0) und {/Symbol b}=d"
set label 2 "Stddev  of estimation error : {/Symbol s}_b"
