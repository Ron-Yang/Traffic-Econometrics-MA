...
##################################################################
set out "PH0_PriorGauss_beta0eq0.eps"
print "plotting PH0_PriorGauss_beta0eq0.eps"
##################################################################
...
strTitle(beta0)=sprintf("Gaussverteilte wahre Werte mit A-Priori-Wahrscheinlichkeit\
 P(H_0)=%1.4f", phi(beta0))
set xlabel "p-Wert der Messung"
set ylabel "A-Posteriori Wahrscheinlichkeit der Nullhypothese H_0"
set label 1 at screen 0.55,0.35
set label 2 at screen 0.55,0.30
set label 1 "Standardabweichung der wahren Werte: {/Symbol s}_{/Symbol b}"
...
##################################################################
set out "PH0_PriorGauss_beta0eq1sigbeta.eps"
print "plotting PH0_PriorGauss_beta0eq1sigbeta.eps"
##################################################################
beta0=1.
print "beta0=",beta0," H0 probability phi(beta0)=",phi(beta0)
set title strTitle(beta0)
...
##################################################################
set out "PH0_PriorGauss_beta0eq3sigbeta.eps"
print "plotting PH0_PriorGauss_beta0eq3sigbeta.eps"
##################################################################
beta0=3.
print "beta0=",beta0," H0 probability phi(beta0)=",phi(beta0)
set title strTitle(beta0)
...
##################################################################
set out "PH0_PriorGauss_beta0eqm1sigbeta.eps"
print "plotting PH0_PriorGauss_beta0eqm1sigbeta.eps"
##################################################################
beta0=-1.
print "beta0=",beta0," H0 probability phi(beta0)=",phi(beta0)
set title strTitle(beta0)
...
##################################################################
set out "PH0_PriorGauss_beta0eqm0.5sigbeta.eps"
print "plotting PH0_PriorGauss_beta0eqm0.5sigbeta.eps"
##################################################################
beta0=-0.5
print "beta0=",beta0," H0 probability phi(beta0)=",phi(beta0)
set title strTitle(beta0)
