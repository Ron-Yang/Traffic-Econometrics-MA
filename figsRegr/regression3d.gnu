...
#################################
# Definition der Contourlinien  (falls set contour aktiv, s.u.)
#################################
...
# (unabhaengig sowohl vom Bereich der zi als auch der tats. z-Werte!!)
# tatsaechl. min/max. der Farben unabhaengig von zrange 
# mit "set cbrange" steuerbar

valGreen=0.1 # geht auch mit Variablen und Float's 
...
# Reihenfolge der sets und unsets egal!
#################################
...
# => "set pm3d", DANN "set pm3d map" noetig fuer Wegbringen der Linien!
...
#set surface         # pm3d off: Erzeugt ueberhaupt Gitternetz
                            # pm3d on: Realisiert Verdeckte Flaechen und KS-Linien
...
set noparam
set term post eps color solid enhanced "Helvetica" 18
...
set out "regression3d.eps"
print "plotting regression3d.eps ..."


set style line 99 lt 6 lw 2 lc rgb "#000000"
...
set out "color2dContour2d.eps"
print "plotting color2dContour2d.eps ..."
...
# Rueckgaengigmachen der spezif. 2D-Einstellungen
set nogrid
...
set out "color3dContour3d.eps"
print "plotting color3dContour3d.eps ..."
unset surface
set pm3d  
set contour surface
splot aIDMdv0bmax(y,x) w l lt 6 lw 4 
...
set out "color3dContour3dGrid3d.eps"
print "plotting color3dContour3dGrid3d.eps ..."
unset surface
set style line 99 lt 7 lw 1        # Farbe+Dicke fuer optionales Gitternetz
...
set out           "color3dContour3dGrid3dHidden3d.eps"
print "plotting color3dContour3dGrid3dHidden3d.eps ..."
set surface
set style line 99 lt 7 lw 1        # Farbe+Dicke fuer optionales Gitternetz
set pm3d  hidden3d 99 
set contour surface
...
set out           "color3dContour2d3dGrid3dHidden3d.eps"
print "plotting color3dContour2d3dGrid3dHidden3d.eps ..."
set surface
set pm3d  hidden3d 99 
set contour both
splot aIDMdv0bmax(y,x) w l lt 6 lw 4 
...
set out "onlyContour3dGrid3d.eps"
print "plotting onlyContour3dGrid3d.eps ..."
unset pm3d
set surface
set contour surface
...
set out "accIDM.dvs.eps"
print "plotting accIDM.dvs.eps ..."
set pm3d  
set contour surface
...
set yrange [-2:10]
set zrange [-9:3]
set out "accIDM.dvs_cont.eps"
print "plotting accIDM.dvs_cont.eps ..."
