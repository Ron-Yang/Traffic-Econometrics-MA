...
\section{SP Survey WS18/19: Alternativ-Specific Time Sensitivities plus
Weather Factor}


%###################################################
\frame{\frametitle{SP survey WS18/19: alternativ-specific time 
sensitivities and weather factor (\red{red: bad weather, $W=1$})}
%###################################################
\vspace{0.5em}
...
\fig{0.8\textwidth}{SC_WS1819_3alt_altspecT_weather_ProbPT_T.png}
...
\fig{0.75\textwidth}{SC_WS1819_3alt_altspecT_weather_ProbPT_Entf.png}
}
...
\placebox[center]{0.50}{0.76}{\parbox{1.0\textwidth}{\small
  $V_i=\beta_0\delta_{i1} + \beta_1\delta_{i2} + \beta_2 K
   + \beta_3 T_1\delta_{i1} + \beta_4 T_2\delta_{i2}
   + \beta_5 T_3\delta_{i3} + \beta_6 W\delta_{i3}
  $
}}

\placebox[center]{0.25}{0.42}{\parbox{0.55\textwidth}{
  \begin{center}
    \figSimple{0.55\textwidth}{SC_WS1819_3alt_altspecT_weather_L_beta2_beta3.png}\\
    Likelihood function\\
    $L(\beta_2,\beta_3|\hatbeta_0, ...)$
  \end{center}
}}
...
\placebox[center]{0.75}{0.42}{\parbox{0.55\textwidth}{
  \begin{center}
    \figSimple{0.55\textwidth}{SC_WS1819_3alt_altspecT_weather_lnL_beta2_beta3.png}\\
    Log-Likelihood function\\
    $\tilde{L}(\beta_2,\beta_3|\hatbeta_0, ...)$
  \end{center}
}}
...
\placebox[center]{0.50}{0.42}{
 \figSimple{0.90\textwidth}{SC_WS1819_3alt_altspecT_weather_corrMatrix.png}
}
