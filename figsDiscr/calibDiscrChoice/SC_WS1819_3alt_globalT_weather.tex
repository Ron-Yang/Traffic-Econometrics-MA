...
\section{SP Survey WS18/19: Global Time Sensitivities plus
Weather Factor}


%###################################################
\frame{\frametitle{SP survey WS18/19: global time 
sensitivities plus weather factor (\red{red: bad weather, $W=1$})}
%###################################################
\vspace{0.5em}
...
\fig{0.8\textwidth}{SC_WS1819_3alt_globalT_weather_ProbPT_T.png}
...
\fig{0.75\textwidth}{SC_WS1819_3alt_globalT_weather_ProbPT_Entf.png}
}
...
\placebox[center]{0.25}{0.42}{\parbox{0.55\textwidth}{
  \begin{center}
    \figSimple{0.55\textwidth}{SC_WS1819_3alt_globalT_weather_L_beta2_beta3.png}\\
    Likelihood function\\
...
\placebox[center]{0.75}{0.42}{\parbox{0.55\textwidth}{
  \begin{center}
    \figSimple{0.55\textwidth}{SC_WS1819_3alt_globalT_weather_lnL_beta2_beta3.png}\\
...
\placebox[center]{0.50}{0.42}{
 \figSimple{0.90\textwidth}{SC_WS1819_3alt_globalT_weather_corrMatrix.png}
}
