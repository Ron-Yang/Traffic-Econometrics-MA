...
//#############################################################
 ...
 double Vfunc(int i, 
	     ...
	     const double beta[]){
   double V=beta[0]*SdataPers[0]*delta(i,0) //!!! don't forget to remove semicolon!!
     +beta[1]*SdataPers[0]*delta(i,1) //!!! don't forget to remove semicolon!!
     +beta[2]*SdataPers[0]*delta(i,2) //!!! don't forget to remove semicolon!!
     +beta[3]*delta(i,0)
     +beta[4]*delta(i,1)
     +beta[5]*delta(i,2);
