...
###############################
set out "RC_skript_4alt_r_probit_fProb.eps"
print "plotting RC_skript_4alt_r_probit_fProb.eps"
###############################
...
set xrange [0.9:]
plot\
  "RC_skript_4alt_r_probit.outData" u ($1):($2/$10) t "Daten Fu\337" w p ls 7,\
  "RC_skript_4alt_r_probit.outData" u ($1):($3/$10) t "Daten Rad" w p ls 5,\
  "RC_skript_4alt_r_probit.outData" u ($1):($4/$10) t "Daten \326V" w p ls 2,\
  "RC_skript_4alt_r_probit.outData" u ($1):($6/$10) t "Modell Fu\337" w l ls 7,\
  "RC_skript_4alt_r_probit.outData" u ($1):($7/$10) t "Modell Rad" w l ls 5,\
  "RC_skript_4alt_r_probit.outData" u ($1):($8/$10) t "Modell \326V" w l ls 2
...
##############################
set out "RC_skript_4alt_r_probit_L_beta0_beta1.eps"
print "plotting RC_skript_4alt_r_probit_L_beta0_beta1.eps"
##############################
...
splot "RC_skript_4alt_r_probit_beta0_beta1" u (logitFact*$1):(logitFact*$2):(exp($3-lnLmax))  w l ls 1
...
##############################
set out "RC_skript_4alt_r_probit_lnL_beta0_beta1.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta0_beta1.eps"
##############################
set xlabel beta0label; set xrange[logitFact*beta0-w_stddev*sig0:logitFact*beta0+w_stddev*sig0]
set ylabel beta1label; set yrange[logitFact*beta1-w_stddev*sig1:logitFact*beta1+w_stddev*sig1]
splot "RC_skript_4alt_r_probit_beta0_beta1" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1
...
##############################
set out "RC_skript_4alt_r_probit_lnL_beta0_beta2.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta0_beta2.eps"
##############################
set xlabel beta0label; set xrange[logitFact*beta0-w_stddev*sig0:logitFact*beta0+w_stddev*sig0]
set ylabel beta2label; set yrange[logitFact*beta2-w_stddev*sig2:logitFact*beta2+w_stddev*sig2]
splot "RC_skript_4alt_r_probit_beta0_beta2" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta1_beta2.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta1_beta2.eps"
##############################
set xlabel beta1label; set xrange[logitFact*beta1-w_stddev*sig1:logitFact*beta1+w_stddev*sig1]
set ylabel beta2label; set yrange[logitFact*beta2-w_stddev*sig2:logitFact*beta2+w_stddev*sig2]
splot "RC_skript_4alt_r_probit_beta1_beta2" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

#quit falls Mparam=3


##############################
set out "RC_skript_4alt_r_probit_lnL_beta0_beta3.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta0_beta3.eps"
##############################
set xlabel beta0label; set xrange[logitFact*beta0-w_stddev*sig0:logitFact*beta0+w_stddev*sig0]
set ylabel beta3label; set yrange[logitFact*beta3-w_stddev*sig3:logitFact*beta3+w_stddev*sig3]
splot "RC_skript_4alt_r_probit_beta0_beta3" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta1_beta3.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta1_beta3.eps"
##############################
set xlabel beta1label; set xrange[logitFact*beta1-w_stddev*sig1:logitFact*beta1+w_stddev*sig1]
set ylabel beta3label; set yrange[logitFact*beta3-w_stddev*sig3:logitFact*beta3+w_stddev*sig3]
splot "RC_skript_4alt_r_probit_beta1_beta3" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta2_beta3.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta2_beta3.eps"
##############################
set xlabel beta2label; set xrange[logitFact*beta2-w_stddev*sig2:logitFact*beta2+w_stddev*sig2]
set ylabel beta3label; set yrange[logitFact*beta3-w_stddev*sig3:logitFact*beta3+w_stddev*sig3]
splot "RC_skript_4alt_r_probit_beta2_beta3" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1
...
##############################
set out "RC_skript_4alt_r_probit_lnL_beta0_beta4.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta0_beta4.eps"
##############################
set xlabel beta0label; set xrange[logitFact*beta0-w_stddev*sig0:logitFact*beta0+w_stddev*sig0]
set ylabel beta4label; set yrange[logitFact*beta4-w_stddev*sig4:logitFact*beta4+w_stddev*sig4]
splot "RC_skript_4alt_r_probit_beta0_beta4" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta1_beta4.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta1_beta4.eps"
##############################
set xlabel beta1label; set xrange[logitFact*beta1-w_stddev*sig1:logitFact*beta1+w_stddev*sig1]
set ylabel beta4label; set yrange[logitFact*beta4-w_stddev*sig4:logitFact*beta4+w_stddev*sig4]
splot "RC_skript_4alt_r_probit_beta1_beta4" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta2_beta4.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta2_beta4.eps"
##############################
set xlabel beta2label; set xrange[logitFact*beta2-w_stddev*sig2:logitFact*beta2+w_stddev*sig2]
set ylabel beta4label; set yrange[logitFact*beta4-w_stddev*sig4:logitFact*beta4+w_stddev*sig4]
splot "RC_skript_4alt_r_probit_beta2_beta4" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta3_beta4.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta3_beta4.eps"
##############################
set xlabel beta3label; set xrange[logitFact*beta3-w_stddev*sig3:logitFact*beta3+w_stddev*sig3]
set ylabel beta4label; set yrange[logitFact*beta4-w_stddev*sig4:logitFact*beta4+w_stddev*sig4]
splot "RC_skript_4alt_r_probit_beta3_beta4" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

#quit falls Mparam=5


##############################
set out "RC_skript_4alt_r_probit_lnL_beta0_beta5.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta0_beta5.eps"
##############################
set xlabel beta0label; set xrange[logitFact*beta0-w_stddev*sig0:logitFact*beta0+w_stddev*sig0]
set ylabel beta5label; set yrange[logitFact*beta5-w_stddev*sig5:logitFact*beta5+w_stddev*sig5]
splot "RC_skript_4alt_r_probit_beta0_beta5" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta1_beta5.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta1_beta5.eps"
##############################
set xlabel beta1label; set xrange[logitFact*beta1-w_stddev*sig1:logitFact*beta1+w_stddev*sig1]
set ylabel beta5label; set yrange[logitFact*beta5-w_stddev*sig5:logitFact*beta5+w_stddev*sig5]
splot "RC_skript_4alt_r_probit_beta1_beta5" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta2_beta5.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta2_beta5.eps"
##############################
set xlabel beta2label; set xrange[logitFact*beta2-w_stddev*sig2:logitFact*beta2+w_stddev*sig2]
set ylabel beta5label; set yrange[logitFact*beta5-w_stddev*sig5:logitFact*beta5+w_stddev*sig5]
splot "RC_skript_4alt_r_probit_beta2_beta5" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta3_beta5.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta3_beta5.eps"
##############################
set xlabel beta3label; set xrange[logitFact*beta3-w_stddev*sig3:logitFact*beta3+w_stddev*sig3]
set ylabel beta5label; set yrange[logitFact*beta5-w_stddev*sig5:logitFact*beta5+w_stddev*sig5]
splot "RC_skript_4alt_r_probit_beta3_beta5" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1

##############################
set out "RC_skript_4alt_r_probit_lnL_beta4_beta5.eps"
print "plotting RC_skript_4alt_r_probit_lnL_beta4_beta5.eps"
##############################
set xlabel beta4label; set xrange[logitFact*beta4-w_stddev*sig4:logitFact*beta4+w_stddev*sig4]
set ylabel beta5label; set yrange[logitFact*beta5-w_stddev*sig5:logitFact*beta5+w_stddev*sig5]
splot "RC_skript_4alt_r_probit_beta4_beta5" u (logitFact*$1):(logitFact*$2):($3)  w l ls 1
