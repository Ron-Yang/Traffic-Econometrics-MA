print "hint: Update lnLmax and beta from SC_WS1819_3alt_globalT_weather.outData"

######################################################
# Input aus SC_WS1819_3alt_globalT_weather.outData
######################################################
...
N=161. 
Mparam=5.   #params
beta0=-0.650674; sig0=0.374274
beta1=-0.419939; sig1=0.247196
beta2=-0.0970603; sig2=0.204327
beta3=-0.0914242; sig3=0.0239731
beta4=4.24174; sig4=1.1454
...
beta3label="{/Symbol b}_3 (Time sensitivity)"
beta4label="{/Symbol b}_4 (Sensitivity weather)"
...
V(i,T0,T1,T2,C,W)=\
 ...
 + beta2*C*delta(i,2)\
 + beta3*T0*delta(i,0)+beta3*T1*delta(i,1)+beta3*T2*delta(i,2)\
 + beta4*W*delta(i,2)
...
print "AC Ped-PT/Car in min  = -beta0/beta3= ",-beta0/beta3
print "AC Bike-PT/Car  in min  = -beta1/beta3= ",-beta1/beta3
print "AC Ped-PT/Car in Euro = -beta0/beta2= ",-beta0/beta2
print "AC Bike-PT/Car  in Euro = -beta1/beta2= ",-beta1/beta2
print "Zeitwert in Euro/h = 60*beta3/beta2= ",60*beta3/beta2
print "Wert weatherdummy PT/Car vs Ped/Bike in Euro = -beta4/beta2= ",-beta4/beta2
...
set style line 99 lt 1 lw 2 pt 4 ps 1.5 linecolor rgb "#1100EE" #blau, solid, open box
...
###############################
set out "SC_WS1819_3alt_globalT_weather_fProb.png"
print "plotting SC_WS1819_3alt_globalT_weather_fProb.png"
###############################
...
set xrange [0.9:]
plot[t=0:1]\
  "calibDiscrChoice/SC_WS1819_3alt_globalT_weather.outData" u ($1):($2/$8) t "Data Ped" w p ls 17,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT_weather.outData" u ($1):($5/$8) t "Model Ped" w l ls 17,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT_weather.outData" u ($1):(($2+$3)/$8)\
     t "Data Ped+Bike" w p ls 2,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT_weather.outData" u ($1):(($5+$6)/$8)\
...
###############################
set out        "SC_WS1819_3alt_globalT_weather_ProbPT_T.png"
print "plotting SC_WS1819_3alt_globalT_weather_ProbPT_T.png"
###############################
...
###############################
set out        "SC_WS1819_3alt_globalT_weather_ProbPT_Entf.png"
print "plotting SC_WS1819_3alt_globalT_weather_ProbPT_Entf.png"
###############################
...
###############################
set out        "SC_WS1819_3alt_globalT_weather_AequiRatio_PT_Bike.png"
print "plotting SC_WS1819_3alt_globalT_weather_AequiRatio_PT_Bike.png"
###############################
...
dT, cost(1,  T1, T1+dT,1) t "P_{PT}/P_{Bike}=1:1, weather bad" w l ls 5

###############################
set out        "SC_WS1819_3alt_globalT_weather_AequiRatio_PT_Bike_highT.png"
print "plotting SC_WS1819_3alt_globalT_weather_AequiRatio_PT_Bike_highT.png"
###############################
T1=60.
set title sprintf("Linien  P_{PT}/P_{Bike}=const bei T_{Bike}=%2.0f Minuten",T1);
plot [dT=dTmin:dTmax]\
...
##############################
set out "SC_WS1819_3alt_globalT_weather_L_beta2_beta3.png"
print "plotting SC_WS1819_3alt_globalT_weather_L_beta2_beta3.png"
##############################
...
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta2_beta3" u 1:2:(exp($3-lnLmax))  w l ls 1
...
##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta0_beta1.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta0_beta1.png"
##############################
...
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta0_beta1" u 1:2:($3)  w l ls 1

#quit falls Mparam=2


##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta0_beta2.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta0_beta2.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta2label; set yrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta0_beta2" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta1_beta2.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta1_beta2.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta2label; set yrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta1_beta2" u 1:2:($3)  w l ls 1

#quit falls Mparam=3


##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta0_beta3.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta0_beta3.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta0_beta3" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta1_beta3.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta1_beta3.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta1_beta3" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta2_beta3.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta2_beta3.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta2_beta3" u 1:2:($3)  w l ls 1
...
##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta0_beta4.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta0_beta4.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta0_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta1_beta4.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta1_beta4.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta1_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta2_beta4.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta2_beta4.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta2_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta3_beta4.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta3_beta4.png"
##############################
set xlabel beta3label; set xrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta3_beta4" u 1:2:($3)  w l ls 1

#quit falls Mparam=5
quit

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta0_beta5.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta0_beta5.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta0_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta1_beta5.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta1_beta5.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta1_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta2_beta5.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta2_beta5.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta2_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta3_beta5.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta3_beta5.png"
##############################
set xlabel beta3label; set xrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta3_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_weather_lnL_beta4_beta5.png"
print "plotting SC_WS1819_3alt_globalT_weather_lnL_beta4_beta5.png"
##############################
set xlabel beta4label; set xrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_weather_beta4_beta5" u 1:2:($3)  w l ls 1
