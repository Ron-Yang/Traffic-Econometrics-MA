...
#################################
set out "p1ProbitTrinom_V1V2.eps"
print "plotting p1ProbitTrinom_V1V2.eps"
#################################
...
set ylabel "V_2-V_3 (Einheiten {/Symbol s_e})" offset -1,0
set yrange [V2min:V2max]
unset cntrparam
#set cntrparam levels incr 0,0.1,1
set cntrparam levels discrete\
 0.02, 0.04, 0.06, 0.08, 0.098,\
 0.100, 0.102, 0.12, 0.14, 0.16, 0.18, 0.198,\
 0.200, 0.202, 0.22, 0.24, 0.26, 0.28, 0.298,\
 0.300, 0.302, 0.32, 0.34, 0.36, 0.38, 0.398,\
 0.400, 0.402, 0.42, 0.44, 0.46, 0.48, 0.498,\
 0.500, 0.502, 0.52, 0.54, 0.56, 0.58, 0.598,\
 0.600, 0.602, 0.62, 0.64, 0.66, 0.68, 0.698,\
 0.700, 0.702, 0.72, 0.74, 0.76, 0.78, 0.198,\
 0.800, 0.802, 0.82, 0.84, 0.86, 0.88, 0.898,\
 0.900, 0.902, 0.92, 0.94, 0.96, 0.98

splot P1trinom(x,y) w l lt 6 lw 2 

#################################
set out "p2ProbitTrinom_V1V2.eps"
print "plotting p2ProbitTrinom_V1V2.eps"
#################################
splot P2trinom(x,y) w l lt 6 lw 2 
...
print "\nplotting kalProbitTrinom_beta1beta2.eps\n"
#################################
