print "hint: Update lnLmax and beta from SC_WS1819_3alt_globalT.outData"

######################################################
# Input aus SC_WS1819_3alt_globalT.outData
######################################################
lnLinit=-176.877
lnLmax=-141.533
Mparam=4
N=161        #(number of single choices)
beta0=-0.949631; sig0=0.36562
beta1=-0.280521; sig1=0.237509
beta2=0.165586; sig2=0.190823
beta3=-0.042309; sig3=0.0172342
...
###############################
set out "SC_WS1819_3alt_globalT_fProb.png"
print "plotting SC_WS1819_3alt_globalT_fProb.png"
###############################
...
set xrange [0.9:]
plot[t=0:1]\
  "calibDiscrChoice/SC_WS1819_3alt_globalT.outData" u ($1):($2/$8) t "Data Ped" w p ls 17,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT.outData" u ($1):($5/$8) t "Model Ped" w l ls 17,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT.outData" u ($1):(($2+$3)/$8)\
     t "Data Ped+Bike" w p ls 2,\
  "calibDiscrChoice/SC_WS1819_3alt_globalT.outData" u ($1):(($5+$6)/$8)\
...
###############################
set out        "SC_WS1819_3alt_globalT_ProbPT_T.png"
print "plotting SC_WS1819_3alt_globalT_ProbPT_T.png"
###############################
...
###############################
set out        "SC_WS1819_3alt_globalT_ProbPT_Entf.png"
print "plotting SC_WS1819_3alt_globalT_ProbPT_Entf.png"
###############################
...
###############################
set out        "SC_WS1819_3alt_globalT_AequiRatio_PT_Bike.png"
print "plotting SC_WS1819_3alt_globalT_AequiRatio_PT_Bike.png"
###############################
...
###############################
set out        "SC_WS1819_3alt_globalT_AequiRatio_PT_Bike_highT.png"
print "plotting SC_WS1819_3alt_globalT_AequiRatio_PT_Bike_highT.png"
###############################
T1=60.
set title sprintf("Linien  P_{PT}/P_{Bike}=const bei T_{Bike}=%2.0f Minuten",T1);
plot [dT=dTmin:dTmax]\
...
##############################
set out "SC_WS1819_3alt_globalT_L_beta2_beta3.png"
print "plotting SC_WS1819_3alt_globalT_L_beta2_beta3.png"
##############################
...
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta2_beta3" u 1:2:(exp($3-lnLmax))  w l ls 1
...
##############################
set out "SC_WS1819_3alt_globalT_lnL_beta0_beta1.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta0_beta1.png"
##############################
...
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta0_beta1" u 1:2:($3)  w l ls 1

#quit falls Mparam=2


##############################
set out "SC_WS1819_3alt_globalT_lnL_beta0_beta2.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta0_beta2.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta2label; set yrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta0_beta2" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta1_beta2.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta1_beta2.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta2label; set yrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta1_beta2" u 1:2:($3)  w l ls 1

#quit falls Mparam=3


##############################
set out "SC_WS1819_3alt_globalT_lnL_beta0_beta3.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta0_beta3.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta0_beta3" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta1_beta3.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta1_beta3.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta1_beta3" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta2_beta3.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta2_beta3.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta3label; set yrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta2_beta3" u 1:2:($3)  w l ls 1
...
##############################
set out "SC_WS1819_3alt_globalT_lnL_beta0_beta4.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta0_beta4.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta0_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta1_beta4.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta1_beta4.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta1_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta2_beta4.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta2_beta4.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta2_beta4" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta3_beta4.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta3_beta4.png"
##############################
set xlabel beta3label; set xrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
set ylabel beta4label; set yrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta3_beta4" u 1:2:($3)  w l ls 1

#quit falls Mparam=5
quit

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta0_beta5.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta0_beta5.png"
##############################
set xlabel beta0label; set xrange[beta0-w_stddev*sig0:beta0+w_stddev*sig0]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta0_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta1_beta5.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta1_beta5.png"
##############################
set xlabel beta1label; set xrange[beta1-w_stddev*sig1:beta1+w_stddev*sig1]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta1_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta2_beta5.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta2_beta5.png"
##############################
set xlabel beta2label; set xrange[beta2-w_stddev*sig2:beta2+w_stddev*sig2]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta2_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta3_beta5.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta3_beta5.png"
##############################
set xlabel beta3label; set xrange[beta3-w_stddev*sig3:beta3+w_stddev*sig3]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta3_beta5" u 1:2:($3)  w l ls 1

##############################
set out "SC_WS1819_3alt_globalT_lnL_beta4_beta5.png"
print "plotting SC_WS1819_3alt_globalT_lnL_beta4_beta5.png"
##############################
set xlabel beta4label; set xrange[beta4-w_stddev*sig4:beta4+w_stddev*sig4]
set ylabel beta5label; set yrange[beta5-w_stddev*sig5:beta5+w_stddev*sig5]
splot "calibDiscrChoice/SC_WS1819_3alt_globalT_beta4_beta5" u 1:2:($3)  w l ls 1
