...
set label 1 "Trinomial Logit" at screen 0.4,yrel front
set label 2 "P_1" at screen 0.86,yrel front


#scalefact=pi/sqrt(6)  # if units sigma_epsilon
#set xlabel "V_1-V_3 (Units {/Symbol s_e})"
#set ylabel "V_2-V_3 (Units {/Symbol s_e})"
#V1min=-3
#V1max=4
#V2min=-4
#V2max=4

scalefact=1.  # if original Logit units (pi/sqrt(6)*sigma_epsilon)
V1min=-3
V1max=4
V2min=-4
V2max=4
...
splot P1trinom(scalefact*x,scalefact*y) w l ls 99 
...
set label 1 "Logit" at screen 0.48,yrel front
...
splot[x=beta1min*scalefact:beta1max*scalefact][y=beta2min*scalefact:beta2max*scalefact]\
  x/scalefact,y/scalefact,logL(x,y) w l ls 99


#################################
set out "kalLogitTrinom_beta1beta2.eps"
print "plotting kalLogitTrinom_beta1beta2.eps\n"
#################################
...
splot[x=beta1min*scalefact:beta1max*scalefact][y=beta2min*scalefact:beta2max*scalefact]\
  x/scalefact,y/scalefact,logLtri(x,y) w l ls 99
