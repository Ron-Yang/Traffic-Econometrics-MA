...
hatbeta1=-0.456565  #from BNL_Entfernung_2007-2011.Newton.gnu
hatbeta2=1.09616
lnLmax=-138.05
zmin=-180
dz=2 # distance of contour lines
...
##############################
set out "BNL_Entfernung_2007-2011_logL_eng.png"
print "plotting BNL_Entfernung_2007-2011_logL_eng.png"
##############################
...
set noparam
set key right top
set label 1 "ln L" at screen 0.7,0.7 front
...
unset cntrparam
set cntrparam levels incr zmin, dz, 0  # last arg=zmax
set title "RC in-class queries 2007-2011"
splot logL(x,y) t "" w l lt 6 lw 1

unset label 1


############################
set out "BNL_Entfernung_2007-2011_relHaeuf_eng.png"
print "plotting BNL_Entfernung_2007-2011_relHaeuf_eng.png"
############################
...
print "N1=",N1
print "N1mod=",N1mod
print "maximized logL=",logL(hatbeta1,hatbeta2)
