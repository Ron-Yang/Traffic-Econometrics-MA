...
%##############################################################
 \placebox{0.50}{0.35}{\maintextSimple{Due to a  \bfblue{Latex bug} no
...
\hline\noalign{\smallskip}
\bfblueTUD{Parameter} & \bfblueTUD{Cars Highway} & \bfblueTUD{Cars City}
                      & \bfblueTUD{Trucks Hwy} & \bfblueTUD{Bicycles} \\
